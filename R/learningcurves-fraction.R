# Experiment to generate learning curves with a changing fraction of labeled objects
...
lc <- LearningCurveSSL(models,datasets,
                       ...
                       measures=measures,
                       type="fraction",
                       n_l=0,test_fraction=0.2,
                       repeats=1000,verbose=TRUE,
                       pre_scale = TRUE, pre_pca = TRUE,
                       low_level_cores = detectBatchCPUs())

save(lc,file="R/learningcurves-fraction.RData")
